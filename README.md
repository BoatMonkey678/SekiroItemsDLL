...
## Plans for future
I plan to add a "Debug" release, where every single item can be granted (for example Rot Essences, or Remnants), as well as an option to grant item by ID (when you have custom items in a mod). This would be made primarily as a way for mod developers to quickly test something. However don't count on it being out very soon.
